...
public class WithdrawServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request ,HttpServletResponse response ) throws IOException
	{
		...
		try
		{
			...
			int withdraw_balance = Integer.parseInt(request.getParameter("withdraw_amount"));
			...
			if (rs.next())
				{	
		         ...
		         if (withdraw_balance > Balance_Amount)
		         {
					    out.println("<p style='color:red'>");
						out.println("ERROR : Withdrawal Amount is greater than balance.");
						out.println("</p>");
		         }
		         else
		         {
		         Balance_Amount = Balance_Amount - withdraw_balance ;
